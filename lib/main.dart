import 'package:escuelapp/pages/busqueda.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        home: const MyHomePage(title: 'Escuelapp'));
  }
}
      ...
      Column(
        children: <Widget>[
          ...
          ElevatedButton(
            ...
            onPressed: () => buscarAlumno(context, controladorInput.text),
...
buscarAlumno(context, matricula) {
  Navigator.push(
    context,
    MaterialPageRoute(
